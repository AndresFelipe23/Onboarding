package com.afes.onboarding_android;
...
public class IntroActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList.add(new ScreenItem("Onboarding 1", "Bienvenidos a mi aplicación \n" +
                "aquí veras un ejemplo de un \n" +
                "onboarding", R.drawable.page_uno));
        mList.add(new ScreenItem("Onboarding 2", "Bienvenidos a mi aplicación \n" +
                "aquí veras un ejemplo de un \n" +
                "onboarding", R.drawable.page_dos));
        mList.add(new ScreenItem("Onboarding 3", "Bienvenidos a mi aplicación \n" +
                "aquí veras un ejemplo de un \n" +
                "onboarding", R.drawable.page_tres));
